...
This is just a simple Hello World! webapp made with Ruby on Rails!
...
```sh
  git clone https://github.com/Arch-Noize/hellorails.git
  cd hellorails
```
...
Feel free to check the [Isues Pages](https://github.com/Arch-Noize/hellorails/issues)
